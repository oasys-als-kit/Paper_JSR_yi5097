...
for is_fit in [0,1,2,3]:
    if is_fit == 0:
        filenames = ["intensity0",
                     ...
                     "intensity3",
                     "intensity4",]
        filepng = dirpng + "intensityuncorrected.pdf"
    elif is_fit == 1:
        filenames = ["intensity0",
                     "intensitycorrected1",
                     "intensitycorrected2",
                     "intensitycorrected3",
                     "intensitycorrected4", ]
        filepng = dirpng + "intensitycorrected.pdf"
    elif is_fit == 2:
        filenames = ["intensity0",
        ...
        filepng = dirpng + "intensitycorrectedextrapolated.pdf"
    elif is_fit == 3:
        filenames = ["intensity0",
        ...
        filepng = dirpng + "intensitycorrectedcropped.pdf"
    ...
    for i in range(1,len(filenames)):
        ...
        LEGEND.append("%s (%3.2f, %3.2f)"%(TITLES[i],FWHM[i],STREHL[i]/STREHL[0]))
    ...
    # plt.subplots_adjust(bottom=0.15)
        ...
        # )
    ax = plt.subplot(111)
    ax.legend(bbox_to_anchor=[.6325,.55])
